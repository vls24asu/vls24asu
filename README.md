...
class Lalitha:
    def __init__(self):
        ...
        self.role      = "AI Engineer  ·  MS SWE @ ASU 🌵"
        self.interests = [
            "🤖 Agentic AI & LLMs",
            "🕸️  Neuro-Symbolic Systems",
            "👁️  Computer Vision",
            "🌐 Knowledge Graphs"
        ]
        self.now       = "GEMR:KG — global risk KG  [IADIS 2026 ✅]"
        self.fun       = "hackathon winner 🏆 | IEEE scholar 🏅 | unity nerd 🎮"

    def say_hi(self):
        return "let's build something that actually thinks 🧠🌿"
```
...
|:---|:---|:---|
| 🧠 **GEMR:KG** | Knowledge graph for global economic risk — LLM-to-SPARQL interface, multi-hop reasoning | RDF/OWL · GraphDB · Python · SPARQL |
| 🫘 **Kidney Function Classifier** | YOLOv5 + VGG16 pipeline on DTPA scans — 94% precision, live Tkinter GUI | Python · YOLOv5 · VGG16 |
| 🚗 **City Courier** | 3D sim with NavMesh AI traffic, proximity spatial audio & NPC dialogue | C# · Unity 6 URP |
| 🏆 **AccuLoad** | Hackathon 1st place — truck load prediction at 91% accuracy | Python · Scikit-learn · CV |
...
<table border="0" cellspacing="0" cellpadding="6">
  <tr>
    <td><img src="https://img.shields.io/badge/🎓%20New%20American%20University%20Scholar-Merit%20Based%20Award%20%40%20ASU-8B9E5A?style=for-the-badge&labelColor=fce4ec&color=8B9E5A" /></td>
  </tr>
  <tr>
    <td><img src="https://img.shields.io/badge/🏅%20IEEE%20Richard%20E.%20Merwin%20Scholar-Global%20Awardee%20%2B%20Student%20Branch%20Treasurer-8B9E5A?style=for-the-badge&labelColor=fce4ec&color=8B9E5A" /></td>
  </tr>
  <tr>
    <td><img src="https://img.shields.io/badge/📄%20Published%20%40%20IADIS%202026-GEMR%3AKG%20Accepted%20to%20International%20Conference-8B9E5A?style=for-the-badge&labelColor=fce4ec&color=8B9E5A" /></td>
  </tr>
  <tr>
    <td><img src="https://img.shields.io/badge/🏆%20Hackathon%20Winner-1st%20Place%20out%20of%2050%2B%20Teams%20%40%20Galgotias%20University-8B9E5A?style=for-the-badge&labelColor=fce4ec&color=8B9E5A" /></td>
  </tr>
</table>
